...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | If you have an existing Claude/Anthropic agent, set its ID here.
    | When configured, the service will send prompts to the agent-specific
    | responses endpoint instead of the standard completion endpoint.
    |
    */

    'agent_id' => env('ANTHROPIC_AGENT_ID'),
];
